...
export default function FileInput(props: FileInputProps) {
  ...
  return (
    <div
      onClick={handleClick}
      className="p-4 flex flex-col items-center gap-2 bg-white text-[#5091F8] hover:bg-[#7A92FC1A] rounded-lg cursor-pointer w-full"
    >
      ...
      {!!props.selectedFiles?.length && (
        <div className="p-4 mt-4 white overflow-hidden text-ellipsis">
          <p>Selected Files:</p>
